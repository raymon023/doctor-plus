            ...
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <a href="{{ route('medicos.create') }}" class=" btn btn-success mb-3" data-toggle="modal"
                        data-target="#createciudad">Nuevo seguro</a>

                    <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                <th scope="col">Nombre</th>
                                <th scope="col">Cod seguro</th>
                                    ...
                                    <td>
                                        <form action="{{ route('seguros.destroy', $seguro) }}" method="POST"
                                            ...
                                            <a class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#updateciudad{{ $seguro->id }}"><i
                                                    class="fas fa-pencil-alt "></i></a>
                                            <a class="btn btn-danger  btn-sm" type="submit"
                                                onclick="archiveRemove(this)" id="{{ $seguro->id }} "><i
                                                    class="fas fa-trash dark"></i></a>
                                        </form>
                                    </td>
                                </tr>

                                {{-- Modal update --}}
                                <div class="modal fade" id="updateciudad{{ $seguro->id }}" tabindex="-1"
                                        ...
                                        <form action="{{ route('seguros.update', $seguro) }}" method="POST">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Modifica seguro
                                                        medico
                                                    </h5>
                                                ...
                                                <div class="card mt-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="apellido"><b>Cod.Seguro:</b></label>
                                                                <input type="text" class="form-control"
                                                                    name="cod_seguro"
                                                                    placeholder="Ingresar codigo seguro"
                                                                    value="{{ $seguro->cod_seguro }}">

                                                            </div>

                                                            <div class="form-group col-md-6">
                                                                <label for="apellido"><b>Email:</b></label>
                                                                <input type="email" class="form-control" name="email"
                                                                    placeholder="Ingresar la direccion de correo"
                                                                    value="{{ $seguro->email }}">

                                                            </div>

                                                            <div class="form-group col-md-6">
                                                                <label for="apellido"><b>Rnc:</b></label>
                                                                <input type="text" class="form-control" name="rnc"
                                                                    placeholder="Ingresar rnc"
                                                                    value="{{ $seguro->rnc }}">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="apellido"><b>Tel 1:</b></label>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="apellido"><b>Tel 2:</b></label>
            ...
            <div class="modal fade" id="createciudad" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-lg">
                    <form action="{{ route('seguros.store') }}" method="POST">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Crear seguro medico</h5>
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="apellido"><b>Cod.Seguro:</b></label>
                                            <input type="text" class="form-control" name="cod_seguro"
                                                placeholder="Ingresar codigo seguro">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="apellido"><b>Email:</b></label>
                                            <input type="email" class="form-control" name="email"
                                                placeholder="Ingresar tiempo de uso">
