        ...
        <div id="layoutSidenav_content">
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <a href="{{ route('medicos.create') }}" class=" btn btn-success mb-3">Nuevo medico</a>
                                    ...
                                    <td>
                                        <form action="{{ route('medicos.destroy', $medico) }}" method="POST"
                                            ...
                                            <a href="{{ route('medicos.edit', $medico) }}"
                                                class="btn btn-warning btn-sm" b><i class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-danger btn-sm" type="submit" onclick="archiveRemove(this)"
                                                id="{{ $medico->id }} "><i class="fas fa-trash"></i></a>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
