            ...
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <a href="{{ route('medicos.create') }}" class=" btn btn-success mb-3" data-toggle="modal"
                        data-target="#createciudad">Nueva ciudad</a>
                        ...
                        <tbody>
                            ...
                            @foreach ($ciudades as $ciudade)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $ciudade->created_at->format('d-m-y') }}</td>
                                    <td>{{ $ciudade->updated_at->format('d-m-y') }}</td>
                                    <td>
                                        <form action="{{ route('ciudades.destroy', $ciudade) }}" method="POST"
                                            class="archiveItem">

                                            @csrf
                                            @method('DELETE')
                                            <a href="" class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#updateciudad{{ $ciudade->id }}"><i
                                                    class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-danger btn-sm" type="submit" onclick="archiveRemove(this)"
                                                id="{{ $ciudade->id }} "><i class="fas fa-trash"></i></a>
                                        </form>
                                    </td>
                                </tr>

                                {{-- Modal update --}}
                                <div class="modal fade" id="updateciudad{{ $ciudade->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="card mt-3">
                                                    <div class="card-header">
                                                        Ingresar la informacion del paciente
                                                    </div>
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" value="{{ $ciudade->nombre }}"
