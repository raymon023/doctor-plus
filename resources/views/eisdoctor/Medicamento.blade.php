            ...
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <a href="{{ route('medicos.create') }}" class=" btn btn-success mb-3" data-toggle="modal"
                        data-target="#createciudad">Nuevo medicamento</a>
                        ...
                        <tbody>
                            ...
                            @foreach ($medicamentos as $medicamento)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $medicamento->tiempo_uso }}</td>
                                    <td>{{ $medicamento->created_at->format('d-m-y') }}</td>
                                    <td>{{ $medicamento->updated_at->format('d-m-y') }}</td>
                                    <td>
                                        <form action="{{ route('medicamentos.destroy', $medicamento) }}"
                                            method="POST" class="archiveItem">

                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#updateciudad{{ $medicamento->id }}"><i class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-danger btn-sm" type="submit" onclick="archiveRemove(this)"
                                                id="{{ $medicamento->id }} "><i class="fas fa-trash"></i></a>
                                        </form>
                                    </td>
                                </tr>

                                {{-- Modal update --}}
                                <div class="modal fade" id="updateciudad{{ $medicamento->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="{{ route('medicamentos.update', $medicamento) }}"
                                            method="POST">
                                                ...
                                                <div class="card mt-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="apellido"><b>Tiempo de uso:</b></label>
                                                                <input type="text" class="form-control"
                                                                    name="tiempo_uso"
                                                                    placeholder="Ingresar tiempo de uso"
                                                                    value="{{ $medicamento->tiempo_uso }}">
