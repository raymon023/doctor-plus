...
<body class="sb-nav-fixed">
                            ...
                            <div class="form-row">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <select name="paciente_id" id="pacienteR" class="form-control" onchange="datospaciente(this)">
                                            <option value="null" selected default>--Selecionar--</option>
                                            @foreach ($referimiento as $p)
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="especialidad"><b>Referido A:</b></label>
                                        <input id="sexo" type="text" class="form-control" name="referido" placeholder="Referido A:">
                                    ...
                                    <div class="form-group col-md-6 mt-1">
                                        <div class="form-floating">
                                            ...
                                            <textarea class="form-control" name="hist_clinica" placeholder="Historial clinica" style="height:150px" style="resize: none"></textarea>
                                    ...
                                    <div class="form-group col-md-6 mt-1">
                                        <div class="form-floating">
                                            ...
                                            <textarea class="form-control" name="observacion" placeholder="Observacion" style="height:150px" style="resize: none"></textarea>
    ...
    <script>
        function datospaciente(el) {
            ...
            var edad = $('option:selected', el).attr('data-edad');
            $("#edad").val(edad);
