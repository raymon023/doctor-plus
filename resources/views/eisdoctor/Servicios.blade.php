                    ...
                    <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <form action="" method="POST" class="archiveItem">

                                        @csrf
                                        @method('DELETE')
                                        <a href="" class="btn btn-warning btn-sm" b><i class="fas fa-pencil-alt"></i></a>
                                        <a class="btn btn-danger btn-sm" type="submit" onclick="archiveRemove(this)" id=" "><i class="fas fa-trash"></i></a>
                                    </form>
                                </td>
                            </tr>
