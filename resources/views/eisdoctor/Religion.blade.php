    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <a href="{{ route('medicos.create') }}" class=" btn btn-success mb-3" data-toggle="modal"
                        data-target="#createciudad">Nueva religion</a>
                    ...
                    <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($religiones as $religione)
                                ...
                                <tr>
                                    <td>{{ $religione->id }}</td>
                                    <td>{{ $religione->nombre }}</td>
                                    <td>{{ $religione->created_at->format('d-m-y') }}</td>
                                    <td>{{ $religione->updated_at->format('d-m-y') }}</td>
                                    <td>
                                        <form action="{{ route('religiones.destroy', $religione) }}" method="POST"
                                            class="archiveItem">

                                            @csrf
                                            @method('DELETE')
                                            <a href="" class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#updateciudad{{ $religione->id }}"><i
                                                    class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-danger btn-sm" type="submit" onclick="archiveRemove(this)"
                                                id="{{ $religione->id }} "><i class="fas fa-trash"></i></a>
                                        </form>
                                    </td>
                                </tr>

                                {{-- Modal update --}}
                                <div class="modal fade" id="updateciudad{{ $religione->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="{{ route('religiones.update', $religione) }}" method="POST">
                                            {!! Form::hidden('medico_id', auth()->user()->medico_id) !!}
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Modificar religiones
                                                    </h5>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" value="{{ $religione->nombre }}"
            ...
            <div class="modal fade" id="createciudad" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <form action="{{ route('religiones.store') }}" method="POST">
                        {!! Form::hidden('medico_id', auth()->user()->medico_id) !!}
                        @csrf
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Crear religion</h5>
