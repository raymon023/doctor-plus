            ...
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <a href="{{ route('medicos.create') }}" class=" btn btn-success mb-3" data-toggle="modal"
                        data-target="#createciudad">Nueva ocupacion</a>
                    ...
                    <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($ocupaciones as $ocupacione)
                                ...
                                <tr>
                                    <td>{{ $ocupacione->id }}</td>
                                    <td>{{ $ocupacione->nombre }}</td>
                                    <td>{{ $ocupacione->created_at->format('d-m-y') }}</td>
                                    <td>{{ $ocupacione->updated_at->format('d-m-y') }}</td>
                                    <td>
                                        <form action="{{ route('ocupaciones.destroy', $ocupacione) }}" method="POST"
                                            class="archiveItem">

                                            @csrf
                                            @method('DELETE')
                                            <a href="" class="btn btn-warning  btn-sm" data-toggle="modal"
                                                data-target="#updateciudad{{ $ocupacione->id }}"><i class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-danger btn-sm" type="submit" onclick="archiveRemove(this)"
                                                id="{{ $ocupacione->id }} "><i class="fas fa-trash"></i></a>
                                        </form>
                                    </td>
                                </tr>

                                {{-- Modal update --}}
                                <div class="modal fade" id="updateciudad{{ $ocupacione->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="{{ route('ocupaciones.update',$ocupacione) }}" method="POST">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" value="{{$ocupacione->nombre}}" class="form-control" name="nombre"
