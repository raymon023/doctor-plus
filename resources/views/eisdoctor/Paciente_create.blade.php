                        ...
                        <div class="form-row">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="date" class="form-control" name="fecha_nac" placeholder="Ingresar telefono">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="direccion" placeholder="Ingresar direccion">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="lugar_trabj" placeholder="Ingresar cedula">
