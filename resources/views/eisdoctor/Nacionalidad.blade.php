            ...
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <a href="{{ route('medicos.create') }}" class=" btn btn-success mb-3" data-toggle="modal"
                        data-target="#createciudad">Nueva nacionalidad</a>
                        ...
                        <tbody>
                            ...
                            @foreach ($nacionalidades as $nacionalidade)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $nacionalidade->nombre }}</td>
                                    <td>{{ $nacionalidade->created_at->format('d-m-y') }}</td>
                                    <td>{{ $nacionalidade->updated_at->format('d-m-y') }}</td>
                                    <td>
                                        <form action="{{ route('nacionalidades.destroy', $nacionalidade) }}"
                                            method="POST" class="archiveItem">

                                            @csrf
                                            @method('DELETE')
                                            <a href="" class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#updateciudad{{ $nacionalidade->id }}"><i
                                                    class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-danger btn-sm" type="submit" onclick="archiveRemove(this)"
                                                id="{{ $nacionalidade->id }} "><i class="fas fa-trash"></i></a>
                                        </form>
                                    </td>
                                </tr>

                                {{-- Modal update --}}
                                <div class="modal fade" id="updateciudad{{ $nacionalidade->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="{{ route('nacionalidades.update', $nacionalidade) }}"
                                            method="POST">
