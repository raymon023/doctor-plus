    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container-fluid mt-3">
                <h4>Evolucion diaria</h4>
                <div class="card mt-2 mx-2">

                    <div class="card-body">
                        <form action={{route('evolucion.store')}} method="POST">
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <select name="paciente_id" id="evolucionD" class="form-control" onchange="datospaciente(this)">
                                            <option value="0" selected default>--Selecionar--</option>
                                            @foreach ($evolucionD as $p)
                                    ...
                                    <div class="form-group col-md-12 mt-1">
                                        <div class="form-floating">
                                            <label for="floatingTextarea" class="form-label"><b>Evolucion</b></label>
                                            <textarea class="form-control" name="evolucion" placeholder="Evolucion" style="height:150px" style="resize: none"></textarea>
