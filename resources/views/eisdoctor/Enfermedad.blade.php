            ...
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <a href="{{ route('medicos.create') }}" class=" btn btn-success mb-3" data-toggle="modal"
                        data-target="#createciudad">Nueva enfermedad</a>
                        ...
                        <tbody>
                            ...
                            @foreach ($enfermedades as $enfermedade)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $enfermedade->created_at->format('d-m-y') }}</td>
                                    <td>{{ $enfermedade->updated_at->format('d-m-y') }}</td>
                                    <td>
                                        <form action="{{ route('enfermedades.destroy', $enfermedade) }}"
                                            method="POST" class="archiveItem">

                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#updateciudad{{ $enfermedade->id }}"><i class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-danger btn-sm" type="submit" onclick="archiveRemove(this)"
                                                id="{{ $enfermedade->id }} "><i class="fas fa-trash"></i></a>
                                        </form>
                                    </td>
                                </tr>

                                {{-- Modal update --}}
                                <div class="modal fade" id="updateciudad{{ $enfermedade->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="{{ route('enfermedades.update', $enfermedade) }}"
                                            method="POST">
            ...
            <div class="modal fade" id="createciudad" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <form action="{{ route('enfermedades.store') }}" method="POST">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Crear enfermedad</h5>
