            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse active" id="collapseEstadisticas" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <div class="collapse" id="collapseHistorial" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{ route('reports_date') }}">Historial de
                                    consultas</a>
                        ...
                        <a class="nav-link collapsed active " href="#" data-toggle="collapse"
                            data-target="#collapseConfig" aria-expanded="false" aria-controls="collapsePages">
                            ...
                            <div class="form-row">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <select name="paciente_id" id="certificado" class="form-control"
                                            onchange="datospaciente(this)">
                                            <option value="0" selected default>--Selecionar--</option>
                                            @foreach ($pacientes as $p)

                                                <option value="{{ $p->id }}"
                                                    data-nombre="{{ $p->full_name }}"
                                                    data-cedula="{{ $p->cedula }}" data-sexo="{{ $p->sexo }}"
                                                    data-ciudades="{{ $p->ciudades->nombre }}">
                                                    {{ $p->full_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input id="ciudades" name="ciudad" type="text" class="form-control"
                                    ...
                                    <div class="form-group col-md-5">
                                        <label for="cedula"><b>Tiempo de reposo:</b></label>
                                        <input type="text" class="form-control" name="reposo"
                                            placeholder="Tiempo de reposo">
                                    ...
                                    <div class="form-group col-md-12 mt-1">
                                        <div class="form-floating">
                                            <label for="floatingTextarea"
                                                class="form-label"><b>Diagnostico</b></label>
                                            <textarea class="form-control" name="diagnostico"
                                                placeholder="Diagnostico" id="motivo" style="height:150px"
