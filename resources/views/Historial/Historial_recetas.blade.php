        ...
        <div id="layoutSidenav_content">
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <h4 class="mb-3">Historial | Recetas</h4>
                    ...
                    <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $receta->pacientes->nombre }}</td>
                                <td>{{ $receta->pacientes->apellido }}</td>
                                <td>{{ $receta->pacientes->cedula }}</td>
                                <td>{{ $receta->pacientes->poliza }}</td>
                                <td>{{ $receta->medicamento1 }}</td>
                                <td>{{ $receta->created_at->format('d/m/Y') }}</td>
                                <td>
                                    <a class="btn btn-primary btn-sm" href="{{route('receta.pdf',['receta'=>$receta])}}"><i class="fa fa-print"></i> imprimir</a>
