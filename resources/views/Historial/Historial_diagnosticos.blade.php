                    ...
                    <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$diagnostico->pacientes->full_name}}</td>
                                <td>{{$diagnostico->pacientes->edad}}</td>
                                <td>{{$diagnostico->pacientes->email}}</td>
                                <td>{{$diagnostico->created_at->format('d-m-Y')}}</td>
                                <td>
                                    <a class="btn btn-primary btn-sm" href="{{route('diagnosticos.pdf',['diagnostico'=>$diagnostico])}}">Imprimir</a>
