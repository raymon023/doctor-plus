        ...
        <div id="layoutSidenav_content">
            <div class="card mt-5 mx-3">
                ...
                <div class="card-body table-responsive">
                    <a href="{{ route('medicos.create') }}" class=" btn btn-success mb-3" data-toggle="modal" data-target="#servicioM">Crear servicio medico</a>
                    ...
                    <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$s->precio}}</td>
                                <td>{{$s->cobertura_seguro}}</td>
                                <td>{{$s->created_at->format('d-m-Y')}}</td>
                                <td>{{$s->updated_at->format('d-m-Y')}}</td>

                                <td>
                                    <form action={{route('servicios.medicos.delete',$s)}}"" method="POST" class="archiveItem">

                                        @csrf
                                        @method('DELETE')
                                        <a href="" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#updateciudad{{$s->id}}"><i class="fas fa-pencil-alt"></i></a>
                                        <a class="btn btn-danger btn-sm" type="submit" onclick="archiveRemove(this)" id="{{$s->id}}"><i class="fas fa-trash"></i></a>
                                    </form>
                                </td>
                            </tr>

                            {{-- Modal update --}}
                            <div class="modal fade" id="updateciudad{{$s->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <form action="{{route('servicios.medicos.update',$s)}}" method="POST">
                                        {!! Form::hidden('medico_id', auth()->user()->medico_id) !!}
                                        @csrf
                                        @method('PUT')
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Crear servicio medico</h5>
                                            ...
                                            <div class="card mt-3 mx-3 mb-3">
                                                <div class="card-header">
                                                    Ingresa un nuevo servicio medico
                                                </div>
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" class="form-control" value="{{$s->nombre_servicio}}" name="nombre_servicio" placeholder="Nombre del servicio">

                                                        </div>


                                                        <div class="form-group col-md-12">
                                                            <label for="apellido"><b>Precio:</b></label>
                                                            <input type="text" value="{{$s->precio}}" class="form-control" name="precio" placeholder="Precio">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="apellido"><b>Cobertura:</b></label>
                                                            <input type="text" value="{{$s->cobertura_seguro}}" class="form-control" name="cobertura_seguro" placeholder="Cobertura">
            ...
            <!-- Modal -->
            <div class="modal fade" id="servicioM" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <form action="{{route('servicios.medicos.store')}}" method="POST">
                        {!! Form::hidden('medico_id', auth()->user()->medico_id) !!}
                        @csrf
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="card mt-3 mx-3 mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="apellido"><b>Nombre:</b></label>
                                            <input type="text" class="form-control" name="nombre_servicio" placeholder="Nombre del servicio">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="apellido"><b>Cobertura:</b></label>
                                            <input type="text" class="form-control" name="cobertura_seguro" placeholder="Cobertura">
